...
# Dtree uplit Uplift model----------------------------------------------
Dtree_Uplift <- function(Current_Campg_Df, Current_TimeStep){
  
  Current_Campg_Df_control = Current_Campg_Df[Current_Campg_Df$offer==0,]
  Current_Campg_Df_trtmnt = Current_Campg_Df[Current_Campg_Df$offer==1,]
  
  Current_Campg_Df_control$offer = NULL
  Current_Campg_Df_trtmnt$offer = NULL
  
  Control_model = rpart(purchase~., data = Current_Campg_Df_control[,2:35],
                        parms=list(split="information"))
  
  
  Treatment_model = rpart(purchase~., data = Current_Campg_Df_trtmnt[,2:35],
                          parms=list(split="information"))
  ...
  p_c <-predict(Control_model, newdata= predict_DF)
  p_t <- predict(Treatment_model, newdata= predict_DF)
